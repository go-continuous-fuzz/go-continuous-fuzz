...
go-continuous-fuzz is a Go native fuzzing tool that automatically detects and runs fuzz targets in the repository. It is designed to run multiple fuzzing workers concurrently and to persist the generated input corpus, helping continuously test and improve the codebase's resilience.
